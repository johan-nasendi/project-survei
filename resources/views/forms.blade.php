                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="place_of_birth" required="" placeholder="Tempat lahir anda" class="form-control">
                                                {{-- <ul class="parsley-errors-list filled" id="parsley-id-27" aria-hidden="false">
                                                    <li class="parsley-required"> This value is required. </li>
                                                </ul> --}}
                                        </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-md-9">
                                            <input type="email" name="email" class="form-control"  required="" placeholder="Alamat email anda yang aktif">
                                            {{-- <ul class="parsley-errors-list filled" id="parsley-id-27" aria-hidden="false">
                                                <li class="parsley-required"> This value is required. </li>
                                            </ul> --}}
                                        </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="card-box">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nick"  required="" placeholder="Lulus dari program studi apa ?"
                                                class="form-control">
                                                {{-- <ul class="parsley-errors-list filled" id="parsley-id-27" aria-hidden="false">
                                                    <li class="parsley-required"> This value is required. </li>
                                                </ul> --}}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="email"  required="" placeholder="Enter email" class="form-control">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="#" type="text" placeholder="Berapa nilai IPK (Indeks Prestasi Kumulatif) anda?" required="" class="form-control">
                                ...
                                <div class="col-lg-6">
                                    <div class="card-box">
                                            <div class="form-group">
                                                ...
                                                <select  name="#" class="form-control parsley-error" id="test"
                                                required="" data-parsley-id="31" aria-describedby="parsley-id-31"
                                                onchange="showDiv();">
                                                    <option selected>---Pilih---</option>
                                                    <option value="Yes"> Yes </option>
                                                    <option value="No"> No </option>
                                            ...
                                            <div class="form-group" id="hidden_div_yes_two" style="display: none;" >
                                                ...
                                                <input type="text" name="" placeholder=" Berapa bulan setelah lulus anda memperoleh pekerjaan pertama?"
                                                class="form-control">
                                                {{-- <ul class="parsley-errors-list filled"id="parsley-id-29" aria-hidden="false">
                                                    <li class="parsley-required">This value is required</li>
                                                </ul> --}}
                                            ...
                                            <div class="form-group" id="hidden_div_yes_three" style="display: none;" >
                                                ...
                                                placeholder="Bulan ke berapa anda memperoleh pekerjaan anda ?" class="form-control">
                                                {{-- <ul class="parsley-errors-list filled"id="parsley-id-29" aria-hidden="false">
                                                    <li class="parsley-required">This value is required</li>
                                                </ul> --}}
                                            </div>
                                            ...
                                            <div class="form-group" id="hidden_div_yes_four" style="display: none;" >
                                                ...
                                                <input type="number" name="" placeholder="Jumlah Instansi yang dilamar" class="form-control">
                                                {{-- <ul class="parsley-errors-list filled"id="parsley-id-29" aria-hidden="false">
                                                    <li class="parsley-required">This value is required</li>
                                                </ul> --}}
                                                <br>
                                                <input type="number" name="" parsley-trigger="change"
                                                placeholder="Jumlah instansi merespon lamaran" class="form-control">
                                                {{-- <ul class="parsley-errors-list filled"id="parsley-id-29" aria-hidden="false">
                                                    <li class="parsley-required">This value is required</li>
                                                </ul> --}}
                                                <br>
                                                <input type="number" name="" parsley-trigger="change"
                                                placeholder="Jumlah instansi yang mengundang wawancara" class="form-control ">
                                                {{-- <ul class="parsley-errors-list filled"id="parsley-id-29" aria-hidden="false">
                                                    <li class="parsley-required">This value is required</li>
                                                </ul> --}}
                                    ...
                                    <div class="card-box">
                                            ...
                                            <div class="form-group">
                                                <label for="#">Kegiatan apa sajakah yang dirasakan perlu dikembangkan untuk menjalin kerjasama antara institusi dengan ikatan alumni?<span class="text-danger">*</span></label>
                                                    <select name="#" class="form-control" required="" data-parsley-id="31" aria-describedby="parsley-id-31">
                                                        <option selected disabled>---Pilih---</option>
