            ...
            <div class="col-6">
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-md-9">
                        ...
                        class="form-control @error('place_of_birth') is-invalid @enderror" required autocomplete="place_of_birth" >
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-md-9">
                        ...
                        required autocomplete="date_of_birth"  value="{{ old('date_of_birth') }}">
                        @error('date_of_birth')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
