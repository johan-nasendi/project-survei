        ...
        <div class="col-lg-6">
            <div class="card-box">
                    ...
                    <div class="form-group">
                       ...
                       required autocomplete="college_entry_date"  placeholder="Kapan Anda Masuk Kuliah?" class="form-control @error('college_entry_date') is-invalid @enderror">
                ...
                @enderror
                    ...
                    <div class="form-group">
                        <label for="#">Seberapa aktif anda di organisasi tersebut?<span class="text-danger">*</span></label>
                           ...
                           required autocomplete="active_inactive_organization">
                                <option selected disabled>---Pilih---</option>
